...
class HFPegasus(abstract.Paraphrase):
    ...
    def infer(self, input_text, num_return_sequences, num_beams, max_length=60, temperature=1.5):
        batch = self.tokenizer([input_text],truncation=True,padding='longest',max_length=60, return_tensors="pt").to(torch_device)
    ...
    def run(self, texts: list,):
        ...
        infer_ = functools.partial(infer, num_return_sequences=10, num_beams=10)
